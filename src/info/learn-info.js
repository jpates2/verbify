...
import PostItsImg from "../assets/images/postits.jpg";
import SignImg from "../assets/images/sign.jpg";
import TimestableImg from "../assets/images/timestable.jpg";
...
export const LearnInfo = [
  ...
  },
  {
    ...
    description: "Sign up and explore your personalized user profile – the central hub for your language progress. Track your streak, review previous scores, and receive tailored practice suggestions. It's all about advancing at your own pace, making Spanish learning uniquely tailored to you.",
    img: TimestableImg,
    link: "Start Your Streak Now"
  }
]
